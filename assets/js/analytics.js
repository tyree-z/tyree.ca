...
function x64hash128(t, e) {
   e = e || 0;
   for (
      var $ = (t = t || "").length % 16, f = t.length - $, x = [0, e], r = [0, e], h = [0, 0], o = [0, 0], _ = [2277735313, 289559509], i = [1291169091, 658871167], c = 0;
      c < f;
      c += 16
   )
      (h = [
         (255 & t.charCodeAt(c + 4)) | ((255 & t.charCodeAt(c + 5)) << 8) | ((255 & t.charCodeAt(c + 6)) << 16) | ((255 & t.charCodeAt(c + 7)) << 24),
         (255 & t.charCodeAt(c)) | ((255 & t.charCodeAt(c + 1)) << 8) | ((255 & t.charCodeAt(c + 2)) << 16) | ((255 & t.charCodeAt(c + 3)) << 24),
      ]),
         (o = [
            (255 & t.charCodeAt(c + 12)) | ((255 & t.charCodeAt(c + 13)) << 8) | ((255 & t.charCodeAt(c + 14)) << 16) | ((255 & t.charCodeAt(c + 15)) << 24),
            (255 & t.charCodeAt(c + 8)) | ((255 & t.charCodeAt(c + 9)) << 8) | ((255 & t.charCodeAt(c + 10)) << 16) | ((255 & t.charCodeAt(c + 11)) << 24),
         ]),
   ...
   switch (((h = [0, 0]), (o = [0, 0]), $)) {
      ...
      case 9:
         (o = x64Rotl((o = x64Multiply((o = x64Xor(o, [0, t.charCodeAt(c + 8)])), i)), 33)), (r = x64Xor(r, (o = x64Multiply(o, _))));
      case 8:
      ...
      case 1:
         (h = x64Rotl((h = x64Multiply((h = x64Xor(h, [0, t.charCodeAt(c)])), _)), 31)), (x = x64Xor(x, (h = x64Multiply(h, i))));
   }
   return (
...
function picassoCanvas(t, e, $) {
   ...
   function i(t, e, $) {
      ...
      f.addColorStop(0, c[_(t.getNext(), c.length)]), f.addColorStop(1, c[_(t.getNext(), c.length)]), (e.fillStyle = f);
   }
   ...
   let c = [
      ...
      a = [
         ...
         function t(e, $, f) {
            ...
            ($.font = `${f.height / h}px aafakefontaa`), $.strokeText(r, _(e.getNext(), f.width), _(e.getNext(), f.height), _(e.getNext(), f.width));
         },
         function t(e, $, f) {
            $.beginPath(),
         ...
         function t(e, $, f) {
            $.beginPath(),
               $.moveTo(_(e.getNext(), f.width), _(e.getNext(), f.height)),
               $.quadraticCurveTo(_(e.getNext(), f.width), _(e.getNext(), f.height), _(e.getNext(), f.width), _(e.getNext(), f.height)),
               $.stroke();
         },
         function t(e, $, f) {
            $.beginPath(),
